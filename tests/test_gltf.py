...
class TestConverter(unittest.TestCase):
    ...
    def test_full_asset1(self):
        ...
        """
        gltf_asset = GLTF()
        gltf_asset.create_accessor_set(name="vertices",
    ...
    def test_full_asset2(self):
        """This test data is adapted from https://github.com/KhronosGroup/glTF-Sample-Models/tree/master/2.0/Triangle
        The original test data is not yet recreatable since, for now, buffer can only hold one data type.
        """
        gltf_asset = GLTF()
        gltf_asset.create_accessor_set(name="indices",
                                       ele_type="SCALAR",
                                       comptype_id=5123,
                                       target=34963,
                                       count=3,
        ...
        self.assertDictEqual(gltf_asset.to_dict(),
                             {
                                 ...
                                 "buffers": [
                                     {
                                         "uri": "data:application/octet-stream;base64,AAABAAIA",
                                         "byteLength": 6
                                     },
                                     {
                                         "uri": "data:application/octet-stream;base64,AAAAAAAAAAAAAAAAAACAPwAAAAAAAAAAA"
